...
module wormhole::state {
    ...
    use haneul::package::{UpgradeCap, UpgradeReceipt, UpgradeTicket};
    ...
    /// Retrieve how long after a Guardian set can live for in terms of Haneul
    ...
    #[test_only]
    public fun deposit_fee_test_only(self: &mut State, fee: Balance<HANEUL>) {
    ...
    public fun test_upgrade(self: &mut State) {
        ...
        let receipt = haneul::package::test_upgrade(ticket);
    ...
    ///
    /// NOTE: The Haneul VM performs a check that this method is executed from the
